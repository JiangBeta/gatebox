...
func TestGenerateReverseProxy(t *testing.T) {
	services := []models.Service{
		{
			ID: "s1", Name: "jellyfin", Type: models.RouteTypeReverseProxy,
...
func TestGenerateFileServer(t *testing.T) {
	services := []models.Service{
		{
			ID: "s2", Name: "static", Type: models.RouteTypeFileServer,
...
func TestGenerateSkipsDisabled(t *testing.T) {
	services := []models.Service{
		{
			ID: "s1", Name: "on", Type: models.RouteTypeReverseProxy,
			Domains:  []models.ProxyDomain{{Protocol: models.DomainProtoHTTPS, RootDomain: "on.neob.cn"}},
			Upstream: []string{"127.0.0.1:1"}, Enabled: true,
		},
		{
			ID: "s2", Name: "off", Type: models.RouteTypeReverseProxy,
			Domains:  []models.ProxyDomain{{Protocol: models.DomainProtoHTTPS, RootDomain: "off.neob.cn"}},
	...
	services := []models.Service{
		{
			...
			Domains: []models.ProxyDomain{
				{Protocol: models.DomainProtoHTTPS, Subdomain: "www", RootDomain: "neob.cn"},
				{Protocol: models.DomainProtoHTTP, Subdomain: "lan", RootDomain: "neob.cn"},
			},
	...
	services := []models.Service{
		{
			ID: "s1", Name: "app", Type: models.RouteTypeReverseProxy,
			Domains: []models.ProxyDomain{
				{Protocol: models.DomainProtoHTTPS, Subdomain: "a", RootDomain: "neob.cn"},
			},
			Upstream:  []string{"127.0.0.1:8081", "127.0.0.1:8082", "127.0.0.1:8083"},
			HealthURI: "/health", Enabled: true,
		},
		{
			ID: "s2", Name: "single", Type: models.RouteTypeReverseProxy,
			Domains: []models.ProxyDomain{
				{Protocol: models.DomainProtoHTTPS, Subdomain: "b", RootDomain: "neob.cn"},
			},
	...
	services := []models.Service{
		{
			ID: "s1", Name: "app", Type: models.RouteTypeReverseProxy,
			Domains: []models.ProxyDomain{
				{Protocol: models.DomainProtoHTTPS, Subdomain: "a", RootDomain: "neob.cn", CustomPort: true, Port: 8443},
			},
			Upstream: []string{"127.0.0.1:80"}, Enabled: true,
		},
	}
...
func TestGenerateFragmentApply(t *testing.T) {
	...
	services := []models.Service{
		{
			ID: "s1", Name: "app", Type: models.RouteTypeReverseProxy,
			Domains:  []models.ProxyDomain{{Protocol: models.DomainProtoHTTPS, RootDomain: "a.neob.cn"}},
	...
	services := []models.Service{
		{
			...
			FragmentIDs:        []string{models.FragmentBlockCommon, models.FragmentGzip},
			ExcludeFragmentIDs: []string{models.FragmentBlockCommon},
		},
	}
...
func TestGenerateVariableAndUnresolvedError(t *testing.T) {
	...
	variables := []models.Variable{{Key: "MY_VAR", Value: "hello"}}
	services := []models.Service{
		{
			ID: "s1", Name: "app", Type: models.RouteTypeReverseProxy,
			Domains:  []models.ProxyDomain{{Protocol: models.DomainProtoHTTPS, RootDomain: "a.neob.cn"}},
	...
	bad := []models.Fragment{{ID: "f1", Code: "header {\n\tX <%NOPE%>\n}"}}
...
func TestInterpolateVars(t *testing.T) {
	svc := models.Service{AppID: "app1", Name: "jellyfin", Type: models.RouteTypeReverseProxy, Upstream: []string{"127.0.0.1:8096"}}
	appNames := map[string]string{"app1": "媒体"}
	d := models.ProxyDomain{Protocol: models.DomainProtoHTTPS, Subdomain: "jellyfin", RootDomain: "neob.cn"}
...
func TestGenerateExtraDirectivesPassthrough(t *testing.T) {
	...
	services := []models.Service{
		{
			ID: "s1", Name: "derived", Type: models.RouteTypeReverseProxy,
			Domains: []models.ProxyDomain{{Protocol: models.DomainProtoHTTPS, Subdomain: "a", RootDomain: "neob.cn"}},
			Enabled: true,
...
func TestDefaultEnabledFragmentIDs(t *testing.T) {
	...
	for _, b := range builtins {
		if b.DefaultEnabled && b.ID != models.FragmentBlockCommon {
			want = false
		}
	}
	_ = want
	found := false
	for _, id := range ids {
		if id == models.FragmentBlockCommon {
			found = true
		}
	}
	if !found {
