...
func TestGenerateTLS(t *testing.T) {
	...
	dns := map[string]models.DNSCredential{
		"neob.cn": {Provider: models.ProviderCloudflare, Fields: map[string]string{"token": "tok123"}},
	}
...
func TestGenerateTLSNoMatch(t *testing.T) {
	...
	services := []models.Service{
		{
			ID: "s1", Name: "other", Type: models.RouteTypeReverseProxy,
			Domains:  []models.ProxyDomain{{Protocol: models.DomainProtoHTTPS, RootDomain: "other.example.com"}},
