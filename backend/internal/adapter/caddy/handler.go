...
func interpolateVars(s string, svc model.Service, appNames map[string]string, d model.ProxyDomain, varEnv map[string]string) (string, error) {
...
func renderFragmentBody(code string, svc model.Service, appNames map[string]string, d model.ProxyDomain, varEnv map[string]string) ([]string, error) {
